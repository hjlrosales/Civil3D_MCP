...
/// <summary>
/// Immutable snapshot of everything the health analyzer inspects: the active drawing, the
/// lightweight drawing statistics and the materialized domain collections. Produced by the
/// workflow's collection steps and consumed by <see cref="HealthAnalyzer"/>. Contains no Autodesk
/// types.
/// </summary>
