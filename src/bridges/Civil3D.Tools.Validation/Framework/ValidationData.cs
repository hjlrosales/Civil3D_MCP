...
/// <summary>
/// Immutable snapshot of everything the validation rules inspect: the active drawing, the
/// lightweight drawing statistics and the materialized domain collections. Produced by the
/// workflow's collection step and consumed by every <see cref="IValidationRule"/>. Contains no
/// Autodesk types.
/// </summary>
