...
/// <summary>
/// Immutable outcome of a create-pipe command. Autodesk-free and serializable; the tool layer
...
public sealed record CreatePipeResult
{
    ...
    /// <summary>True when the pipe was created (always true on a successful command).</summary>
