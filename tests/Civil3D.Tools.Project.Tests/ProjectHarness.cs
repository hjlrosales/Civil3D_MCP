...
/// <see cref="WorkflowDispatcher"/>, the production <see cref="ProjectSummaryWorkflowHandler"/>,
/// a fake session/statistics service and the seven fake domain services. Also exposes a
/// <see cref="ToolCatalog"/> over the project tool assembly for SDK-level tests.
/// </summary>
internal static class ProjectHarness
{
        ...
        IStyleService? styles = null)
    {
        ...
        services.AddSingleton<IWorkflowHandler<ProjectSummaryWorkflow, ProjectSummaryReport>, ProjectSummaryWorkflowHandler>();
    ...
    internal static WorkflowContext ProjectContext(
        ServiceProvider provider,
        CancellationToken cancellationToken = default,
        RecordingProgressReporter? progress = null)
        => new(
            WorkflowName: "project.summary.report",
    ...
    internal static ToolCatalog CreateCatalog(Container container)
        => new(
            new[] { typeof(ProjectSummaryReportTool).Assembly },
